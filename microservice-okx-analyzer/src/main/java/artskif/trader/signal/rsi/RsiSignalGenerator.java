...
import artskif.trader.signal.SignalType;
...
public class RsiSignalGenerator {

    private final BigDecimal BUY_TH = BigDecimal.valueOf(30);
    private final BigDecimal SELL_TH = BigDecimal.valueOf(70);
    ...
    public List<Signal> generate(IndicatorFrame frame, StrategyKind strategyKind) {
        ...
        for (IndicatorSnapshot snap : frame.indicators()) { // все индикаторы из фрейма
            ...
            SignalType type = SignalType.rsi(snap.period() == null ? 0 : snap.period());
